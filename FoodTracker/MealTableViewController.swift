...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.locationLabel.text = meal.location
    ...
    */
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Caprese Salad", photo: photo1, rating: 4, location: "Rotterdam, The Netherlands") else {
            fatalError("Unable to instantiate meal1")
        }
        
        guard let meal2 = Meal(name: "Chicken and Potatoes", photo: photo2, rating: 5, location: "Rotterdam, The Netherlands") else {
            fatalError("Unable to instantiate meal2")
        }
        
        guard let meal3 = Meal(name: "Pasta with Meatballs", photo: photo3, rating: 3, location: "Rotterdam, The Netherlands") else {
